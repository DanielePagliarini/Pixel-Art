...
/* keyboard */
const k={}; onkeydown=e=>k[e.key]=1; onkeyup=e=>k[e.key]=0;
...
document.body.appendChild(Object.assign(document.createElement("div"),{className:"btn"})); // placeholder button

function loop(){
  requestAnimationFrame(loop);
  const dx=(k.a?-1:0)+(k.d?1:0)+tDir.x,
        dy=(k.w?-1:0)+(k.s?1:0)+tDir.y;
